        ...
        <DialogContent>
          ...
          {game.modal === "reset" ? (
            ...
            <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
              ...
              <p>{t("Клавиатура: WASD или стрелки перемещают карту, Enter выбирает её центр. Delete / Backspace удаляет выбранное соединение. Ctrl/⌘ + B открывает список войск.")}</p>
